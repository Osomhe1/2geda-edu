...
const DashboardContext = ({children}) => {
    ...
    let isMacpro = useMediaQuery({ query: "(max-width: 1280px)" }); 
  ...
  return (
    <dashboardContext.Provider value={{sidebarOpen, setSidebarOpen, toggleSideBar, isTablet, isMacpro, tabClicked, toggleTab, toggleTabLV3, tabClickedLV3, sidebarMinimized, minimizeSidebar,showminimizedsubMenu, setShowminimizedsubMenu, extendedSubMenuData, setExtendedSubMenuData }}>
       {children}
