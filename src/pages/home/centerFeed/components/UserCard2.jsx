    ...
    <div className=" h-[370px] w-[300px] relative bg-white">
      ...
      >
       <CardBody className="bg-blue-500 flex  px-0 py-0 items-center justify-center">
            ...
            src={user?.FILE_NAME ?  filePrefix + user?.FILE_NAME  :  "/assets/images/placeholder.jpg" ||   "/assets/images/placeholder.jpg"}  
        ...
        <CardFooter className="absolute bg-white bottom-0 z-10  py-3 ">
            ...
            <div className="flex flex-col gap-y-3 w-full">
                <div className="flex flex-grow gap-2 flex-1 items-center">
                    ...
                    <p className="text-tiny ">{user?.LAST_NAME  + ' ' +  user?.FIRST_NAME}</p>
                    <p className="text-tiny text-gray-500/80 ">{user?.DESIGNATION_NAME}</p>
                    
                    </div>
                </div>
                <Button fullWidth color="primary" className="bg-blue-500" radius="full" size="md" onClick={openWishDrawer}>
                    Wish Happy Birthday
                </Button>
            </div>
