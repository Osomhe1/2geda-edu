...
const Announcements = () => {
  ...
  // let dt = [{
  //   ANNOUNCEMENT_ID: 1, SUBJECT: 'test', MESSAGE: 'tst messg'
  // }]
              ...
              <div className="py-1 pb-3 flex-col border-b ">
                    <div className="px-9 text-gray-500 flex justify-between gap-2 items-center">
                        <div className="flex flex-col gap-1">
                            ...
                            <span className="text-xs">2hr ago</span>
                        </div>
                        <Button variant="bordered">mark as read</Button>
                    </div>
                </div>
                      ...
                      <div className="flex gap-x-4 flex-wrap space-y-1 mt-5 items-center">
                        <div className="relative">
                          ...
                          >
                            ...
                            <span>{ann?.ANNOUNCEMENT_FILE}</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex gap-3">
